              ...
              <div class="card-body p-0">
                ...
                <div class="row">
                  <div class="col-lg-5 d-none d-lg-block">
                    <img src="recursos/assets/viajes.jpg" alt="Imagen de registro" class="w-100">
                  </div>
                  <div class="col-lg-7">
                    <div class="p-5">
                      <div class="text-center">
                        <br>
                        <hr>
                        <h6 class="display-6 fw-bolder"><span class="text-gradient d-inline">CREAR VIAJE</span></h6>
                        <hr>
                        <br>
                      ...
                      <form>
                        ...
                        <div class="form-group d-flex align-items-center justify-content-center mt-4 mb-0">
                          <a button class="btn btn-secondary text-white" type="button" href="index.html"><b>Guardar viaje</b></a>
                        </div>
                      </form>
                      <br>
                      <hr>
