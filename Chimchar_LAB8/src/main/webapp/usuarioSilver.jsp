...
<html lang="en">
  ...
  <body class="d-flex flex-column h-100" style="background-image: url(recursos/assets/map-image.png); background-repeat: no-repeat; background-size: cover; background-color: #b8c0c4;">
    <main class="flex-shrink-0">
      <!-- Navigation-->
      <nav class="navbar navbar-expand-lg navbar-light py-3" style="background-color: rgba(70,71,77,0.78);">
        <div class="container px-5">
          <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Silver </div></div>
          <span style="margin-right: 10px;"></span>
          <span style="margin-right: 10px;"></span>
          <a class="navbar-brand" href="<%=request.getContextPath()%>/ViajesServlet?a=silver"><span class="fw-bolder text-white">Bienvenido <%=personaSession.getNombre() + " " + personaSession.getApellido()%>  </span></a>
          <br>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <% ArrayList<MisViajes> viajesPorUsuario = viajesDao.listarViajesUsuarioSilver(idUsuario) ;%>
