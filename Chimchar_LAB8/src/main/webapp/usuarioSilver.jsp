        ...
        <div class="container px-5">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
              <li class="nav-item"><a class="nav-link" href="contact.html"><b class="section-subheading text-light"><u>Cerrar Sesion ></u></b></a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <section class="page-section" id="viajes" >
        <div class="container" >
          ...
          <div class="text-lg-end">
            ...
            <a class="btn btn-success" href="<%=request.getContextPath()%>/ViajesServlet?a=silver">Añadir viaje </a>
            <br>
            <br>
