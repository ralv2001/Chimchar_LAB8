...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100" style="background-image: url(recursos/assets/map-image.png); background-repeat: no-repeat; background-size: cover; background-color: #a8d5ea;">
        <main class="flex-shrink-0">
            <!-- Navigation-->
            <nav class="navbar navbar-expand-lg navbar-light py-3" style="background-color: rgba(52,63,252,0.76);">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<%=request.getContextPath()%>/ViajesServlet?a=editar&id_viaje=<%=listaViajes.getId_mis_viajes()%>" type="button" class="btn btn-light">
