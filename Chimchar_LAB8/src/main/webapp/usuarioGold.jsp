        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light py-3" style="background-color: rgba(245,210,36,0.76);">
                <div class="container px-5">
                    ...
                    <span style="margin-right: 10px;"></span>
                    <a class="navbar-brand" href="index.html"><span class="fw-bolder text-black">Bienvenido @Usuario </span></a>
                    <br>
            ...
            <section class="page-section" id="viajes" >
                <div class="container" >
                    ...
                    <div class="text-lg-end">
                        ...
                        <a class="btn btn-success" href="<%=request.getContextPath()%>/ViajesServlet?a=gold">Añadir viaje </a>
                        <br>
                        <br>
