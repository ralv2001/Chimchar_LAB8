...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100" style="background-image: url(recursos/assets/map-image.png); background-repeat: no-repeat; background-size: cover; background-color: #eceabc;">
        <main class="flex-shrink-0">
            <!-- Navigation-->
            <nav class="navbar navbar-expand-lg navbar-light py-3" style="background-color: rgba(245,210,36,0.76);">
                <div class="container px-5">
                    <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Gold </div></div>
                    <span style="margin-right: 10px;"></span>
                    <span style="margin-right: 10px;"></span>
                    <a class="navbar-brand" href="<%=request.getContextPath()%>/ViajesServlet?a=gold"><span class="fw-bolder text-black">Bienvenido <%=personaSession.getNombre() + " " + personaSession.getApellido()%> </span></a>
                    <br>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            <li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/LoginServlet?action=logout"><b class="section-subheading text-dark"><u>Cerrar Sesion ></u></b></a></li>
                        </ul>
                    </div>
                </div>
            </nav>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <% ArrayList<MisViajes> viajesPorUsuario = viajesDao.listarViajesUsuarioGold(idUsuario) ;%>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<%=request.getContextPath()%>/usuarioGold.jsp" type="button" class="btn btn-light">
